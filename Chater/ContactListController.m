...
- (void)viewDidLoad {
    ...
    if (!self.managedObjectContext) {
        self.managedObjectContext= kAppDel.persistentContainer.viewContext;
    }
}
...
- (void)insertNewObject:(id)sender {
    NSManagedObjectContext *context = [self.fetchedResultsController managedObjectContext]?:kAppDel.persistentContainer.viewContext;
